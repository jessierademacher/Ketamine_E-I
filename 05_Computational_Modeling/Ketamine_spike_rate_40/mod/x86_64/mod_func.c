...
extern void _ProbAMPANMDA_pyrpv_reg(void);
extern void _ProbAMPANMDA_pyrpyr_reg(void);
extern void _ProbAMPANMDA_pyrsst_reg(void);
extern void _ProbAMPANMDA_pyrvip_reg(void);
...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," ProbAMPANMDA_pyrpv.mod");
    fprintf(stderr," ProbAMPANMDA_pyrpyr.mod");
    fprintf(stderr," ProbAMPANMDA_pyrsst.mod");
    fprintf(stderr," ProbAMPANMDA_pyrvip.mod");
  ...
  _Nap_reg();
  _ProbAMPANMDA_reg();
  _ProbAMPANMDA_pyrpv_reg();
  _ProbAMPANMDA_pyrpyr_reg();
  _ProbAMPANMDA_pyrsst_reg();
  _ProbAMPANMDA_pyrvip_reg();
  _ProbUDFsyn_reg();
  _SK_reg();
  _epsp_reg();
  _tonic_reg();
