...
#define nrn_init _nrn_init__ProbAMPANMDA_pyrsst
#define _nrn_initial _nrn_initial__ProbAMPANMDA_pyrsst
#define nrn_cur _nrn_cur__ProbAMPANMDA_pyrsst
#define _nrn_current _nrn_current__ProbAMPANMDA_pyrsst
#define nrn_jacob _nrn_jacob__ProbAMPANMDA_pyrsst
#define nrn_state _nrn_state__ProbAMPANMDA_pyrsst
#define _net_receive _net_receive__ProbAMPANMDA_pyrsst 
#define setRNG setRNG__ProbAMPANMDA_pyrsst 
#define state state__ProbAMPANMDA_pyrsst 
...
#define erand erand_ProbAMPANMDA_pyrsst
 extern double erand( );
 /* declare global and static user variables */
#define mggate mggate_ProbAMPANMDA_pyrsst
 double mggate = 0;
#define mg mg_ProbAMPANMDA_pyrsst
 double mg = 1;
 ...
 "mg_ProbAMPANMDA_pyrsst", &mg_ProbAMPANMDA_pyrsst,
 "mggate_ProbAMPANMDA_pyrsst", &mggate_ProbAMPANMDA_pyrsst,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 6;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA_pyrsst /mnt/antares_raid/home/jessier/layer23_ketamine/code/Ketamine_spike_rate_40/mod/x86_64/ProbAMPANMDA_pyrsst.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 102 in file ProbAMPANMDA_pyrsst.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/antares_raid/home/jessier/layer23_ketamine/code/Ketamine_spike_rate_40/mod/ProbAMPANMDA_pyrsst.mod";
static const char* nmodl_file_text = 
  ...
  "NEURON {\n"
  "\n"
  "        POINT_PROCESS ProbAMPANMDA_pyrsst\n"
