...
#define nrn_init _nrn_init__ProbAMPANMDA_pyrpv
#define _nrn_initial _nrn_initial__ProbAMPANMDA_pyrpv
#define nrn_cur _nrn_cur__ProbAMPANMDA_pyrpv
#define _nrn_current _nrn_current__ProbAMPANMDA_pyrpv
#define nrn_jacob _nrn_jacob__ProbAMPANMDA_pyrpv
#define nrn_state _nrn_state__ProbAMPANMDA_pyrpv
#define _net_receive _net_receive__ProbAMPANMDA_pyrpv 
#define setRNG setRNG__ProbAMPANMDA_pyrpv 
#define state state__ProbAMPANMDA_pyrpv 
...
#define erand erand_ProbAMPANMDA_pyrpv
 extern double erand( );
 /* declare global and static user variables */
#define mggate mggate_ProbAMPANMDA_pyrpv
 double mggate = 0;
#define mg mg_ProbAMPANMDA_pyrpv
 double mg = 1;
 ...
 "mg_ProbAMPANMDA_pyrpv", &mg_ProbAMPANMDA_pyrpv,
 "mggate_ProbAMPANMDA_pyrpv", &mggate_ProbAMPANMDA_pyrpv,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 6;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA_pyrpv /mnt/antares_raid/home/jessier/layer23_ketamine/code/Ketamine_spike_rate_40/mod/x86_64/ProbAMPANMDA_pyrpv.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 102 in file ProbAMPANMDA_pyrpv.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/antares_raid/home/jessier/layer23_ketamine/code/Ketamine_spike_rate_40/mod/ProbAMPANMDA_pyrpv.mod";
static const char* nmodl_file_text = 
  ...
  "NEURON {\n"
  "\n"
  "        POINT_PROCESS ProbAMPANMDA_pyrpv\n"
